...
"""
        ...
        try:
            ...
            self.assertTrue(
                ...
                f"AI commit message should follow conventional format. Got: {ai_message}",
            )
    ...
    def test_ai_commit_with_anthropic_fallback(self):
        ...
        try:
            ...
            from codeup.main import _generate_ai_commit_message_anthropic

            # Verify we have an Anthropic key
            anthropic_key = get_anthropic_api_key()
            self.assertIsNotNone(
                anthropic_key, "Anthropic API key should be available for testing"
            )
            ...
            self.assertIsNotNone(
                anthropic_message, "Anthropic should generate a commit message"
            )
            self.assertIsInstance(
